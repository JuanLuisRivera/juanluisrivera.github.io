document.addEventListener("DOMContentLoaded", () => {
  const listId = "ejercicios-list";
  const itemClass = "ejercicio-item";
  const paginationId = "ejercicios-pagination";
  const toggleButton = document.querySelector(".orden-toggle-ejercicios");
